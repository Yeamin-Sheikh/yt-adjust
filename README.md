...
<p align="center">
  <a href="https://github.com/Yeamin-Sheikh/yt-adjust/releases/tag/v2.3.0"><img src="https://img.shields.io/badge/version-2.3.0-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="Version 2.3.0"></a>
...
<p align="center">
  <a href="https://github.com/Yeamin-Sheikh/yt-adjust/releases/download/v2.3.0/yt-adjust-v2.3.0.zip">
    <img src="https://img.shields.io/badge/Download_Extension_ZIP-v2.3.0-d90429?style=for-the-badge&logo=zip&logoColor=white" alt="Download ZIP">
  </a>
</p>
...
1. Download **[yt-adjust-v2.3.0.zip](https://github.com/Yeamin-Sheikh/yt-adjust/releases/download/v2.3.0/yt-adjust-v2.3.0.zip)** from the releases page.
...
├── manifest.json                  # Manifest V3 configuration (v2.3.0)
├── package.json
├── tsconfig.json
├── .gitignore
└── README.md
